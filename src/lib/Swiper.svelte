    ...
    <div class="flex flex-wrap -m-4">
      <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
        <div class="h-full text-center">
          ...
          <p class="text-lg font-bold text-gray-400 leading-relaxed">I love your food soo much.<br/> I love the Banku and Okro stew</p>
          ...
          <p class="text-gray-500 font-light">Business Woman</p>
        </div>
      </div>
      <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
        <div class="h-full text-center">
          ...
          <p class="text-gray-400 text-lg font-bold leading-relaxed"> I love your food soo much. Its yummy. <br/>Especially the Jangle Rice.</p>
          <span class="inline-block h-1 w-10 rounded bg-red-400 mt-6 mb-4"></span>
      ...
      <div class="lg:w-1/3 lg:mb-0 p-4">
        <div class="h-full text-center">
          ...
          <p class="text-gray-400 text-lg font-bold leading-relaxed">This is soo good. <br/> I love your food soo much. Its yummy.</p>
          <span class="inline-block h-1 w-10 rounded bg-red-400 mt-6 mb-4"></span>
